...
% Fix the issue where lstlistings right after section headings destroy the
% spacing of subsequent headings.
\makeatletter
...
\lstnewenvironment{grammar}{\lstset{language=EBNF}}{}
\lstnewenvironment{mw}{\lstset{language=Maxwell}}{}
