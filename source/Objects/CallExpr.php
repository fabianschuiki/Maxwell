...
class CallExpr extends \RepositoryNodeObject implements \EqualInterface, CallInterface, TypeInterface, GraphInterface
{
	/* PROPERTIES */
	...
	{
		return array("tree","main","call","type","graph");
	}
