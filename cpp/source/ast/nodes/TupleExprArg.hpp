...
public:
	...
	virtual string getClassName() const { return "TupleExprArg"; }
	...
	template<typename T> static Ptr needFrom(const T& n) { Ptr r = boost::dynamic_pointer_cast<TupleExprArg>(n); if (!r) throw std::runtime_error("Node " + n->getId().str() + " cannot be dynamically casted to TupleExprArg."); return r; }
protected:
	NodeRef graphPrev;
	string name;
	NodePtr expr;
